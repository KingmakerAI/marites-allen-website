      ...
      <div className="admin-login">
        <div className="admin-login-card">
          ...
          <div className="admin-login-links">
            {view === "signin" ? (
              <>
                <Link href="/adminportal?view=forgot">Forgot password</Link>
                <span aria-hidden="true">·</span>
                <Link href="/adminportal?view=change">Change password</Link>
              </>
            ) : (
              <>
                <Link href="/adminportal">Back to sign in</Link>
                {view === "reset" ? (
                  <>
                    <span aria-hidden="true">·</span>
                    <Link href="/adminportal?view=forgot">Need a new code?</Link>
                  </>
                ) : null}
                {view === "forgot" ? (
                  <>
                    <span aria-hidden="true">·</span>
                    <Link href="/adminportal?view=change">I know my password</Link>
                  </>
                ) : null}
              </>
            )}
