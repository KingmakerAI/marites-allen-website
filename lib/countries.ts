...
/** ISO 3166-1 alpha-2 countries with dial codes (common international set). */
...
export const FALLBACK_CONSULTATION_OPTIONS = [
  "Personal Feng Shui Consultation",
  "Home / Property Feng Shui",
  "Business Feng Shui",
  "Annual Forecast",
  "Wealth & Prosperity",
  "Relationship & Family",
